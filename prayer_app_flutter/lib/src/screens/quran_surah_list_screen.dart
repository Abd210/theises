...
class _QuranSurahListScreenState extends State<QuranSurahListScreen> {
  ...
  Future<void> _loadSurahs() async {
    ...
    try {
      ...
      if (cached != null && cached.isNotEmpty) {
        ...
        setState(() {
          _error = 'Failed to load surah list';
          _loading = false;
        });
      }
  ...
  Future<void> _openReader(SurahMeta surah) async {
    final initialAyah = _lastRead?.surahNumber == surah.number ? _lastRead!.ayahNumber : 1;
        ...
        child: SafeArea(
          ...
          child: Column(
            children: [
              ...
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: QuranLayout.screenPadding),
                child: Container(
                  height: QuranLayout.searchHeight,
                  decoration: BoxDecoration(
                    color: tc.card,
                    borderRadius: BorderRadius.circular(QuranLayout.searchRadius),
              ...
              Expanded(
                child: _loading && _surahs.isEmpty
                    ...
                    : _error != null && _surahs.isEmpty
                        ? Center(child: Text(_error!, style: AppTypography.caption(tc)))
                        : ListView.builder(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          Text('${s.ayahCount} ayahs', style: AppTypography.caption(tc)),
                                          Text(s.revelationType, style: AppTypography.caption(tc)),
                                        ],
                                      ),
